...
from chatbot.models import SgaPersona, SgaRecordacademico, SgaInscripcion
...
from chatbot.services import (
    ...
    q_horario_semanal,
    q_rubros_pendientes, q_detalle_rubro, q_pagos_realizados, q_bloqueos_financieros,
...
def run_test():
    print(f"--- TESTING FULL ORM SERVICES (Periodo: {PERIODO_ID}) ---")
    ...
    for cedula in TARGET_CEDULAS:
        ...
        print_json_pretty("q_bloqueos_financieros", q_bloqueos_financieros(persona))
